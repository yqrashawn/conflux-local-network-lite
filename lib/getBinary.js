/**
 * @fileOverview functions to download the fullnode binary defined in the json file
 * @name getBinary.js
 */
...
async function downloadAndExtract(url) {
  ...
  await ppipeline(stream(url), extractStream).catch(err => {
    console.log("---------------------------");
    console.error(err);
  });
